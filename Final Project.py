...
window = Tk()
window.geometry("615x975+10+10")
window.title("Unit Converter")


class UnitConverter:
    def __init__(self, win):
        self.txt1 = Entry(win, bd=15, width="11", bg="black", font=("Arial", 70), fg="white")
        ...
        self.shiftbutton = Button(win, bd=1, width="26", text="Shift: Off", height="-15", bg="red", font=("Arial", 28, "bold"))
        self.shiftbutton.grid(row=7, column=0, sticky="nw", padx=5, pady=15)
        ...
        self.btc1.grid(row=7, sticky="nw", padx=5, pady=90)
        ...
        self.btc2.grid(row=7, sticky="nw", padx=157, pady= 90)
        ...
        self.btc3.grid(row=7, sticky="nw", padx=309, pady=90)
        ...
        self.btc4.grid(row=7, sticky="nw", padx=460, pady=90)
        ...
        self.btc5.grid(row=7, sticky="nw", padx=5, pady=175)
        self.btc5.bind('<Button-1>', self.oz_to_g)

        self.btc6 = Button(win, bd=1, width="13", text="lb to kg", height="3", font=("Arial", 14), bg="seashell4")
        self.btc6.grid(row=7, sticky="nw", padx=157, pady=175)
        self.btc6.bind('<Button-1>', self.lb_to_kg)

        self.btc7 = Button(win, bd=1, width="13", text="t to kg", height="3", font=("Arial", 14), bg="seashell4")
        self.btc7.grid(row=7, sticky="nw", padx=309, pady=175)
        self.btc7.bind('<Button-1>', self.t_to_kg)

        self.btc8 = Button(win, bd=1, width="13", text="g to kg", height="3", font=("Arial", 14), bg="seashell4")
        self.btc8.grid(row=7, sticky="nw", padx=460, pady=175)
        self.btc8.bind('<Button-1>', self.g_to_kg)
        # -Time------------------------------------------------------------------------------
        self.btc9 = Button(win, bd=1, width="11", text="s to min", height="3", font=("Arial", 14), bg="seashell4")
        self.btc9.grid(row=7, sticky="nw", padx=5, pady=260)
        self.btc9.bind('<Button-1>', self.sec_to_min)

        self.btc10 = Button(win, bd=1, width="10", text="min to hr", height="3", font=("Arial", 14), bg="seashell4")
        self.btc10.grid(row=7, sticky="nw", padx=136, pady=260)
        self.btc10.bind('<Button-1>', self.min_to_hr)

        self.btc11 = Button(win, bd=1, width="9", text="hr to day", height="3", font=("Arial", 14), bg="seashell4")
        self.btc11.grid(row=7, sticky="nw", padx=255, pady=260)
        self.btc11.bind('<Button-1>', self.hr_to_day)

        self.btc12 = Button(win, bd=1, width="10", text="day to month", height="3", font=("Arial", 14), bg="seashell4")
        self.btc12.grid(row=7, sticky="nw", padx=363, pady=260)
        self.btc12.bind('<Button-1>', self.day_to_month)

        self.btc13 = Button(win, bd=1, width="11", text="month to year", height="3", font=("Arial", 14), bg="seashell4")
        self.btc13.grid(row=7, sticky="nw", padx=482, pady=260)
